...
- [Fetching ConnectionResult with AJAX Requests](#fetching-data-with-ajax-requests)
...
- [Injecting ConnectionResult from the Server into the Page](#injecting-data-from-the-server-into-the-page)
...
* ConnectionResult filenames include content hashes so you don’t need to worry about browsers caching their old versions.
...
* ConnectionResult filenames won’t include content hashes so you’ll need to add query arguments or rename them every time they change.
...
## Fetching ConnectionResult with AJAX Requests
...
## Injecting ConnectionResult from the Server into the Page
